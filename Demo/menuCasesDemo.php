...
foreach ($G_TMP_MENU->Id as $index => $value) {
  if ($index == 3) { //Option CASES_INBOX
    $tmpId[$index + $k]      = "ID_DEMO_MNUCASE_01";
    $tmpTypes[$index + $k]   = "plugins";
    $tmpEnabled[$index + $k] = 1;
    $tmpOptions[$index + $k] = "../Demo/DemoApplication"; //link
    $tmpLabels[$index + $k]  = "Demo application1";
    $tmpJS[$index + $k]      = null;
...
// $tmpId[$i]      = "ID_DEMO_MNUCASE_02";
// $tmpTypes[$i]   = "blockHeader";
// $tmpEnabled[$i] = 1;
// $tmpOptions[$i] = null; //link
// $tmpLabels[$i]  = "Demo application2";
// $tmpJS[$i]      = null;
// $tmpIcons[$i]   = null;
// $tmpEClass[$i]  = null;
...
// $tmpId[$i]      = "ID_DEMO_MNUCASE_03";
// $tmpTypes[$i]   = "plugins";
// $tmpEnabled[$i] = 1;
// $tmpOptions[$i] = "../Demo/DemoApplication2"; //link
// $tmpLabels[$i]  = "Demo application2";
// $tmpJS[$i]      = null;
// $tmpIcons[$i]   = null;
// $tmpEClass[$i]  = null;
...
// $tmpId[$i]      = "ID_DEMO_MNUCASE_04";
// $tmpTypes[$i]   = "blockHeaderNoChild";
// $tmpEnabled[$i] = 1;
// $tmpOptions[$i] = "../Demo/DemoApplication3"; //link
// $tmpLabels[$i]  = "Demo application3";
// $tmpJS[$i]      = null;
// $tmpIcons[$i]   = null;
// $tmpEClass[$i]  = null;
